...
ident=southern-califo-0973.zqz2-bvt2-ztqf-barb
ipaddress=ballroom-b-cam
...
gst-launch-1.0 -v \
  ...
  rtmpsink location="rtmp://a.rtmp.youtube.com/live2/x/${ident}?videoKeyframeFrequency=1&totalDatarate=5128 app=live2 flashVer=\"FME/3.0%20(compatible;%20FMSc%201.0)\" swfUrl=rtmp://a.rtmp.youtube.com/live2"
